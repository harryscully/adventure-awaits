// Small built-in 5-letter word list for Betweenle guess validation.
// Refine later — kept compact and alphabetised.
export const FIVE_LETTER_WORDS = new Set<string>([
  ...
  "BLOOD","BLOOM","BOARD","BOOST","BOOTH","BOUND","BRAIN","BRAND","BRASS","BRAVE",
  ...
  "FRONT","FROST","FROZEN","FRUIT","FULLY","FUNNY","GIANT","GIVEN","GLASS","GLOBE",
  ...
  "WRITE","WRONG","WROTE","YIELD","YOUNG","YOUTH","ZEBRA","BRICK","CRISP","DAISY",
  "EARTH","FROST","GRAPE","LEMON","MANGO","OLIVE","PEACH","RAVEN","SPICE","TIGER",
]);

export function isValidFiveLetter(word: string): boolean {
  return FIVE_LETTER_WORDS.has(word.toUpperCase());
}
